...
public class AchievementScreenView : BaseUI
{
    ...
    private void OnBackToLobbyButtonClicked()
    {
        ...
        GameManager.Instance.UIManager.CloseAchievementScreen();
    }
    ...
    private void ResetRectTransform()
    {
        ...
        {
            Debug.LogError("AchievementScreen RectTransform was not found.");
            return;
        }
