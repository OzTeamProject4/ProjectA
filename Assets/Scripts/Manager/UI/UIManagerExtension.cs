...
public static class UIManagerExtension
{
    ...
    public static async UniTask<SettingPopupView> OpenSettingPopupAsync(this UIManager uiManager,  CancellationToken cancellationToken = default)
    {
        BaseUI baseUI = await uiManager.OpenPopupRootAsync(UIType.SettingPopup, cancellationToken);

        return GetView<SettingPopupView>(baseUI, UIType.SettingPopup);
    }
