...
public partial class PlayerFollowTargetAction : Action
{
    ...
    protected override Status OnStart()
    {
        ...
        Debug.Log($"pos={Self.Value.transform.position} / onNavMesh={_navMeshAgent.isOnNavMesh} / enabled={_navMeshAgent.enabled}");
    ...
    protected override Status OnUpdate()
    {
        ...
        Debug.Log($"desired={_navMeshAgent.desiredVelocity} / onNavMesh={_navMeshAgent.isOnNavMesh} / status={_navMeshAgent.pathStatus}");
